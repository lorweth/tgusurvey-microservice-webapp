...
import vn.vnedu.tgusurvey.userinfo.repository.UnitRepository;
...
/**
 * REST controller for managing {@link vn.vnedu.tgusurvey.userinfo.domain.Unit}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class UnitResource {
    ...
    private static final String ENTITY_NAME = "userinfoUnit";
