...
class EnterpriseGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Enterprise entity")
        ...
        .repeat(2) {
            ...
            .get("/services/userinfo/api/enterprises")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new enterprise")
            .post("/services/userinfo/api/enterprises")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
                ...
                , "representative":"SAMPLE_TEXT"
                , "lineOfBussiness":"SAMPLE_TEXT"
                }""")).asJson
            .check(status.is(201))
            ...
            .repeat(5) {
                ...
                .get("/services/userinfo${new_enterprise_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created enterprise")
            .delete("/services/userinfo${new_enterprise_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
