...
class PositionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Position entity")
        ...
        .repeat(2) {
            ...
            .get("/services/userinfo/api/positions")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new position")
            .post("/services/userinfo/api/positions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "mscv":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/userinfo${new_position_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created position")
            .delete("/services/userinfo${new_position_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
