...
export class LecturerComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.lecturerService
      ...
      .subscribe(
        (res: HttpResponse<ILecturer[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInLecturers(): void {
    this.eventSubscriber = this.eventManager.subscribe('lecturerListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ILecturer[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
