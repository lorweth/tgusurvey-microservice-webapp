...
export class ClassroomComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.classroomService
      ...
      .subscribe(
        (res: HttpResponse<IClassroom[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInClassrooms(): void {
    this.eventSubscriber = this.eventManager.subscribe('classroomListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IClassroom[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
