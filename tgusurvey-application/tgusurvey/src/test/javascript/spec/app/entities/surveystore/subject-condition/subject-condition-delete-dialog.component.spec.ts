...
describe('Component Tests', () => {
  describe('SubjectCondition Management Delete Component', () => {
    let comp: SubjectConditionDeleteDialogComponent;
    let fixture: ComponentFixture<SubjectConditionDeleteDialogComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [SubjectConditionDeleteDialogComponent],
      })
        .overrideTemplate(SubjectConditionDeleteDialogComponent, '')
        .compileComponents();
      fixture = TestBed.createComponent(SubjectConditionDeleteDialogComponent);
