...
class SectionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Section entity")
        ...
        .repeat(2) {
            ...
            .get("/services/surveystore/api/sections")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new section")
            .post("/services/surveystore/api/sections")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "stt":"0"
            ...
            .repeat(5) {
                ...
                .get("/services/surveystore${new_section_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created section")
            .delete("/services/surveystore${new_section_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
