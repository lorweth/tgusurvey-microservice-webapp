...
class QuestionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Question entity")
        ...
        .repeat(2) {
            ...
            .get("/services/surveystore/api/questions")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new question")
            .post("/services/surveystore/api/questions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "content":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/surveystore${new_question_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created question")
            .delete("/services/surveystore${new_question_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
