...
class ClassroomGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Classroom entity")
        ...
        .repeat(2) {
            ...
            .get("/services/userinfo/api/classrooms")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new classroom")
            .post("/services/userinfo/api/classrooms")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "mslh":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/userinfo${new_classroom_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created classroom")
            .delete("/services/userinfo${new_classroom_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
