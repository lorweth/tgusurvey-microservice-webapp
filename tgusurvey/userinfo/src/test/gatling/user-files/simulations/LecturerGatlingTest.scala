...
class LecturerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Lecturer entity")
        ...
        .repeat(2) {
            ...
            .get("/services/userinfo/api/lecturers")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new lecturer")
            .post("/services/userinfo/api/lecturers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "msgv":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/userinfo${new_lecturer_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created lecturer")
            .delete("/services/userinfo${new_lecturer_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
