...
export class EnterpriseComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.enterpriseService
      ...
      .subscribe(
        (res: HttpResponse<IEnterprise[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInEnterprises(): void {
    this.eventSubscriber = this.eventManager.subscribe('enterpriseListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IEnterprise[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
