...
export class EducationProgramComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.educationProgramService
      ...
      .subscribe(
        (res: HttpResponse<IEducationProgram[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInEducationPrograms(): void {
    this.eventSubscriber = this.eventManager.subscribe('educationProgramListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IEducationProgram[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/education-program'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
