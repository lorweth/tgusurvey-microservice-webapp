...
class SubjectGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Subject entity")
        ...
        .repeat(2) {
            ...
            .get("/services/surveystore/api/subjects")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new subject")
            .post("/services/surveystore/api/subjects")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "msmh":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/surveystore${new_subject_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created subject")
            .delete("/services/surveystore${new_subject_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
