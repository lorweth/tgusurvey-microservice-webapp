...
describe('Unit e2e test', () => {
  ...
  it('should load Units', async () => {
    ...
    expect(await unitComponentsPage.getTitle()).to.eq('tgusurveyApp.userinfoUnit.home.title');
  ...
  it('should load create Unit page', async () => {
    ...
    expect(await unitUpdatePage.getPageTitle()).to.eq('tgusurveyApp.userinfoUnit.home.createOrEditLabel');
  ...
  it('should delete last Unit', async () => {
    ...
    expect(await unitDeleteDialog.getDialogTitle()).to.eq('tgusurveyApp.userinfoUnit.delete.question');
