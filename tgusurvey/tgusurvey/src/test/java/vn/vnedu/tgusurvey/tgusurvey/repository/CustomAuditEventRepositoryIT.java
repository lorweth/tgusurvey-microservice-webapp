...
import vn.vnedu.tgusurvey.tgusurvey.TgusurveyApp;

import vn.vnedu.tgusurvey.tgusurvey.config.Constants;
import vn.vnedu.tgusurvey.tgusurvey.config.TestSecurityConfiguration;
import vn.vnedu.tgusurvey.tgusurvey.config.audit.AuditEventConverter;
import vn.vnedu.tgusurvey.tgusurvey.domain.PersistentAuditEvent;
...
import static vn.vnedu.tgusurvey.tgusurvey.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

/**
 * Integration tests for {@link CustomAuditEventRepository}.
 */
@SpringBootTest(classes = {TgusurveyApp.class, TestSecurityConfiguration.class})
@Transactional
