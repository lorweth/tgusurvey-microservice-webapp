...
public class EducationProgramResource {
    ...
    public ResponseEntity<List<EducationProgram>> getAllEducationPrograms(Pageable pageable) {
        log.debug("REST request to get a page of EducationPrograms");
        Page<EducationProgram> page = educationProgramRepository.findAll(pageable);
