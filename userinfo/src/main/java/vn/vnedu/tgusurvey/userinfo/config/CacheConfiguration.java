package vn.vnedu.tgusurvey.userinfo.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("userinfo");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("userinfo");
        ...
        config.getMapConfigs().put("vn.vnedu.tgusurvey.userinfo.domain.*", initializeDomainMapConfig(jHipsterProperties));
